    ...
    const renderMessages = () => {
      ...
      const messageContent = () => {
        if (isFormWrong) {
          ...
          return <Text as="p" variation="info">Sends an email with a one-time password to allow the recipient to record a video.<br/> {isMobile ?  "Email preview will be shown on the next page." : "Email will be sent as shown in the preview on the right."} </Text>;
        }
      };
